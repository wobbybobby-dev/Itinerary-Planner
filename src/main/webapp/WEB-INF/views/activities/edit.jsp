// File: src/main/webapp/WEB-INF/views/activities/edit.jsp
...
<body>
    <nav class="navbar navbar-dark" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
        <div class="container-fluid">
            <span class="navbar-brand">✈️ Edit Activity</span>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <c:if test="${not empty activity}">
                            <form method="post" action="${pageContext.request.contextPath}/activities/${activity.activityId}/update">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form-select" id="activityType" name="activityType">
                                        ...
                                        <option value="Outdoor" ${activity.activityType == 'Outdoor' ? 'selected' : ''}>Outdoor</option>
                                        <option value="Food" ${activity.activityType == 'Food' ? 'selected' : ''}>Food & Dining</option>
                                        <option value="Adventure" ${activity.activityType == 'Adventure' ? 'selected' : ''}>Adventure</option>
                                        <option value="Shopping" ${activity.activityType == 'Shopping' ? 'selected' : ''}>Shopping</option>
                                        <option value="Relaxation" ${activity.activityType == 'Relaxation' ? 'selected' : ''}>Relaxation</option>
                                        <option value="Transportation" ${activity.activityType == 'Transportation' ? 'selected' : ''}>Transportation</option>
                                        <option value="Other" ${activity.activityType == 'Other' ? 'selected' : ''}>Other</option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" class="form-control" id="cost" name="cost" 
                                           step="0.01" min="0" value="${activity.cost}">
                                </div>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <textarea class="form-control" id="notes" name="notes" rows="2">${activity.notes}</textarea>
                                </div>
